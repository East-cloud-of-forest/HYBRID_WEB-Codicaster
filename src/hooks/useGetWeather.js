import clothSVG from '@/lib/clothSVG'
import tempByCloth from '@/lib/tempByCloth'
...
export default function useGetWeather() {
  const getData = async (data) => {
    ...
    const tempByClothData = tempByCloth(Math.round(weatherData.main.temp))
    return {
      onecallData,
      weatherData,
      main: {
      ...
      tempByCloth: {
        ...tempByClothData,
        clothTag: tempByClothData.clothTag.reduce((x, y) => {
          x[y] = clothSVG[y]
          return x
        }, {}),
      },
